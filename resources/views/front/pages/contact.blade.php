        ...
        <div class="container">
            <div class="page-intro">
                ...
                <ul class="bread-crumb">
                    ...
                    <li class="is-marked">
                        <a href="contact.html">{{ __('common.contact_us') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                        ...
                        <form action="{{ url('contact') }}" method="post">
                            ...
                            <div class="group-inline u-s-m-b-30">
                                <div class="group-1 u-s-p-r-16">
                                    ...
                                    <input type="text" id="contact-name" class="text-field" placeholder="Name"
                                        name="name" value="{{ old('name') }}"> {{-- Retrieving Old Input: https://laravel.com/docs/9.x/requests#retrieving-old-input --}}
                                </div>
                                <div class="group-2">
                                    <label for="contact-email">Your Email
                                        <span class="astk">*</span>
                                    </label>
                                    <input type="email" id="contact-email" class="text-field" placeholder="Email"
                                        name="email" value="{{ old('email') }}"> {{-- Retrieving Old Input: https://laravel.com/docs/9.x/requests#retrieving-old-input --}}
                                </div>
                            </div>
                            <div class="u-s-m-b-30">
                                ...
                                <input type="text" id="contact-subject" class="text-field" placeholder="Subject"
                                    name="subject" value="{{ old('subject') }}"> {{-- Retrieving Old Input: https://laravel.com/docs/9.x/requests#retrieving-old-input --}}
                            </div>
                            <div class="u-s-m-b-30">
                            ...
                            <div class="u-s-m-b-30">
                                <button type="submit"
                                    class="button button-outline-secondary">{{ __('common.send_message') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="information-about-wrapper">
                        <h1 class="contact-h1">{{ __('common.information_about_us') }}</h1>
                        <p>
                    ...
                    <div class="contact-us-wrapper">
                        <h1 class="contact-h1">{{ __('common.contact_us') }}</h1>
