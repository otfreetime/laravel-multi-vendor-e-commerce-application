    ...
    <div class="page-style-a">
        <div class="container">
            <div class="page-intro">
                <h2>{{ __('common.my_account') }}</h2>
                <ul class="bread-crumb">
                    <li class="has-separator">
                        <i class="ion ion-md-home"></i>
                        <a href="index.html">{{ __('common.home') }}</a>
                    </li>
                    <li class="is-marked">
                        <a href="account.html">{{ __('common.account') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="login-wrapper">
                        ...
                        <form id="accountForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-email">{{ __('common.email') }}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-name">{{ __('common.name') }}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-address">{{ __('common.address') }}
                                    <span class="astk">*</span>
                                </label>
                                <input class="text-field" type="text" id="user-address" name="address"
                                    value="{{ \Illuminate\Support\Facades\Auth::user()->address }}"> {{-- Retrieving The Authenticated User: https://laravel.com/docs/9.x/authentication#retrieving-the-authenticated-user --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-city">{{ __('common.city') }}
                                    <span class="astk">*</span>
                                </label>
                                <input class="text-field" type="text" id="user-city" name="city"
                                    value="{{ \Illuminate\Support\Facades\Auth::user()->city }}"> {{-- Retrieving The Authenticated User: https://laravel.com/docs/9.x/authentication#retrieving-the-authenticated-user --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-state">{{ __('common.state') }}
                                    <span class="astk">*</span>
                                </label>
                                <input class="text-field" type="text" id="user-state" name="state"
                                    value="{{ \Illuminate\Support\Facades\Auth::user()->state }}"> {{-- Retrieving The Authenticated User: https://laravel.com/docs/9.x/authentication#retrieving-the-authenticated-user --}}
                                ...
                                <select class="text-field" id="user-country" name="country" style="color: #495057">
                                    ...
                                    @foreach ($countries as $country)
                                        ...
                                        <option value="{{ $country['country_name'] }}"
                                            @if ($country['country_name'] == \Illuminate\Support\Facades\Auth::user()->country) selected @endif>
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input class="text-field" type="text" id="user-pincode" name="pincode"
                                    value="{{ \Illuminate\Support\Facades\Auth::user()->pincode }}">
